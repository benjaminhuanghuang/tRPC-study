...
// Create type ExperienceCardMediaProps, which includes only the experience property from ExperienceCardProps.
...
function ExperienceCardMeta({ experience }: ExperienceCardMetaProps) {
  return (
    <div className="📝text-neutral-600 🌙dark:text-neutral-400 flex items-center gap-4">
